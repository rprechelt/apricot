...
Py_Flux(py::module& m) {
  ...
  py::class_<FixedParticleFlux<Helium>>(m, "FixedHeliumFlux")
    .def(py::init<const double>(),
  ...
  py::class_<FixedParticleFlux<Nitrogen>>(m, "FixedNitrogenFlux")
    .def(py::init<const double>(),
  ...
  py::class_<FixedParticleFlux<Iron>>(m, "FixedIronFlux")
    .def(py::init<const double>(),
